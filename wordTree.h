...
class Node {//stores a word from the text
    ...
    Node(const string& v) : _value(v), _left(nullptr),
    		_right(nullptr), _parent(nullptr), _height(0), _count(0) {}
    void printValue(){
...
class WordTree{
     ...
     * *************************************************************/
    int compareHeight(Node* aNode);	// Returns highest height of node's children
    /****************************************************************
