...
class BookTree{
    public:
        ...
        * *************************************************************/
        BNode* find(const string& title);	// Find node using key in splay tree
    ...
    private:
        ...
        * *************************************************************/
        BNode* findHelper(BNode* x, const string& title);	// Recursive helper function for find()
        BNode* insertHelper(const string& title, const string& author, const string& text, BNode* x);	// Helper function for insert
